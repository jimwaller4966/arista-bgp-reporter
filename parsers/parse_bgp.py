...
<header>
  ...
  <div class="header-right">
    ...
    {device_count} devices &nbsp;·&nbsp; {vrf_count} VRFs
  </div>
</header>

<div class="stats">
  <div class="stat">
    <div class="stat-val">{total_paths}</div>
    <div class="stat-label">Total Paths</div>
  </div>
  <div class="stat">
    <div class="stat-val green">{total_prefixes}</div>
    <div class="stat-label">Unique Prefixes</div>
  </div>
  <div class="stat">
    <div class="stat-val purple">{paths_with_communities}</div>
    <div class="stat-label">Paths w/ Communities</div>
  </div>
  <div class="stat">
    <div class="stat-val amber">{unique_communities}</div>
    <div class="stat-label">Unique Communities</div>
  </div>
  <div class="stat">
    <div class="stat-val">{best_paths}</div>
...
def render_html(records, output_file):
    ...
    html = HTML_TEMPLATE.format(
        ...
        paths_with_communities = paths_with_communities,
